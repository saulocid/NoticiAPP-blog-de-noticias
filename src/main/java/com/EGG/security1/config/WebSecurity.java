        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
                http
                                .authorizeHttpRequests((authz) -> authz
                                                ...
                                                .requestMatchers("/admin/*").hasAnyRole("ADMIN", "JOURNAL", "MODERATOR") // Solo los usuarios con rol ADMIN pueden acceder a todos los métodos de l clase PanelAdmController.java
